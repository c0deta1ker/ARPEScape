...
fig.Position(4) = 1.00*pp.fig5x4(2);
...
gca_props();
ax = gca;
ax.XLabel.String = 'Electron Kinetic Energy [eV]'; ax.YLabel.String = 'IMFP [Angstrom]';
...
legend(h, 'Universal','Optical/Experiment','TPP-2M','TPP-2M(avg)','S1','S2(avg)');
end