function int = pGLA_FDD(xdat, x0, peak, fwhm, mr, asym, fdd_ef, fdd_T, fdd_fwhm)
% int = pGLA_FDD(xdat, x0, peak, fwhm, mr, asym, fdd_ef, fdd_T, fdd_fwhm)
...
%
%   REQ. FUNCTIONS:
%   -   pGLA(xdat, x0, peak, fwhm, mr, asym)
%   -   FDDG(xdat, ef, T, fwhm)
%
%   IN:
...
int_pGLA  	= pGLA(xdat, x0, peak, fwhm, mr, asym);
