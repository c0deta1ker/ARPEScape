...
for i = 1:size(dataStr.(dField), 3)
    ...
    if strcmpi(bgrdType,"AngleInt")
        ISubtr = IntAngle(dataStr.(dField)(:,:,i),dataStr.(xField),dataStr.(yField), Win);
...
if plot_result == 1
    ...
    colorbar; title('Raw Data', 'Interpreter', 'none');
    subplot(122); hold on;
    ...
    colorbar; title('Processed Data', 'Interpreter', 'none');
end
