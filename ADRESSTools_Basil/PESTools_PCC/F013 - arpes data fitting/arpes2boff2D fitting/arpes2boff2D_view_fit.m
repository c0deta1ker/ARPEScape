...
for i = 1:fitStr.nSTATES; plot(fitStr.nkx, fitStr.neb{i}, 'r:', 'linewidth', 3); end
img_props(); 
...
for i = 1:fitStr.nSTATES; line([1 1]*fitStr.YLOC(i), [-1e5, 1e5], 'Color', 'r', 'LineWidth', 2, 'Linestyle', ':'); end
gca_props(); grid on;
