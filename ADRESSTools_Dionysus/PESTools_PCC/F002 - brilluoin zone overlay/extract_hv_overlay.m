...
if length(hv) == 1
    surfNormX           = SurfNormX(hv, navi_args.eBref, navi_args.kxref, navi_args.thtM, navi_args.thtAref, navi_args.alpha);
    kx                  = Kxx(hv, navi_args.eBref, navi_args.thtM, tht, surfNormX, navi_args.alpha);
    kz                  = Kzz(hv, navi_args.eBref, navi_args.thtM, tht, navi_args.tltM, navi_args.V000, surfNormX, navi_args.alpha);
elseif length(hv) == 2
