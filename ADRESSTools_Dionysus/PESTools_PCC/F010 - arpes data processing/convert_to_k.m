...
if dataStr.Type == "Eb(k)" || dataStr.Type == "Eb(k,i)" 
    ...
    dataStr.ky = Kyy(dataStr.hv, dataStr.eb, dataStr.tht, dataStr.thtM, dataStr.tltM, dataStr.surfNormX, incAlpha);
    dataStr.kz = Kzz(dataStr.hv, dataStr.eb, dataStr.thtM, dataStr.tht, dataStr.tltM, v000, dataStr.surfNormX, incAlpha);
...
elseif dataStr.Type == "Eb(kx,ky)"
    ...
    for i = 1:size(dataStr.tltM, 2)
        ...
        dataStr.ky(:,:,i) = Kyy(dataStr.hv, dataStr.eb(:,:,i), dataStr.tht(:,:,i), dataStr.thtM, dataStr.tltM(i), dataStr.surfNormX(i), incAlpha);
        dataStr.kz(:,:,i) = Kzz(dataStr.hv, dataStr.eb(:,:,i), dataStr.thtM, dataStr.tht(:,:,i), dataStr.tltM(i), v000, dataStr.surfNormX(i), incAlpha);
    end
...
elseif dataStr.Type == "Eb(kx,kz)"
    ...
    for i = 1:size(dataStr.hv, 2)
        ...
        dataStr.ky(:,:,i) = Kyy(dataStr.hv(i), dataStr.eb(:,:,i), dataStr.tht(:,:,i), dataStr.thtM, dataStr.tltM, dataStr.surfNormX(i), incAlpha);
        dataStr.kz(:,:,i) = Kzz(dataStr.hv(i), dataStr.eb(:,:,i), dataStr.thtM, dataStr.tht(:,:,i), dataStr.tltM, v000, dataStr.surfNormX(i), incAlpha);
    end
end
