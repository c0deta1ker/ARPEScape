function [fitStr0, statStr] = arpes2model_parsolver_p_prctiles(arpesStr, modelStr, iparams, ibgrnd, solve_type, kx_lims, eb_lims, n_runs, prc, p_runs)
% [fitStr0, statStr] = arpes2model_solver_p_prctiles(arpesStr, modelStr, iparams, ibgrnd, solve_type, kx_lims, eb_lims, n_runs, prc, p_runs)
...
%   and repeats this process for 'p_runs' amount of times. Uses Parallel Processing.
%
%   REQ. FUNCTIONS: none
%
%   IN:
...
for p = 1:p_runs
    ...
    [fitStr0, statStr{p}] = arpes2model_parsolver_n_runs(arpesStr, modelStr, iparams, ibgrnd, solve_type, kx_lims, eb_lims, n_runs);
