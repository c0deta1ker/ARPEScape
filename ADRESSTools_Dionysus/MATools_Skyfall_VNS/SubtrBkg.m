...
% A=SubtrBkg(ACorr,EAlign,Data [,EWinNorm] [,scCoeff] [,clipNeg]) subtracts angle-integrated spectral weight from the 
% 2D/3D data array Data. Before the subtraction, the images are normalized to the spectral intensity integrated within the 
% energy window EWinNorm (default 90% of the EAlign range). scCoeff scales the subtracted angle-integrated intensity 
% (default 0.7) and clipNeg indicates whether the negative values are set to zero (default 1) or not (0).  
% Ver. 11.07.2022
