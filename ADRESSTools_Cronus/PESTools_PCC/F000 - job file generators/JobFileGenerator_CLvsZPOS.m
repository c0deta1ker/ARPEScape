function JobFileGenerator_CLvsZPOS()
% JobFileGenerator_CLvsZPOS()
...
%   z-position, where each scan can be referenced to a known Fermi-edge, if 
...
filename    = char("JobFile_CLvsZPOS_" + string(datestr(now,'yyyymmdd_HHMMSS')));
