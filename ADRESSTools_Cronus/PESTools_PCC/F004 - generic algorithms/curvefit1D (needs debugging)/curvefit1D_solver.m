...
%   
%   IN:
%   -   xdat:           [nX × 1] array of the x-axis data
%   -   ydat:           [nY × 1] array of the y-axis data
%   -   curve_type:  	string of the type of curve to be used for fitting. Default: "sGLA" ("pGLA", "sGL", "pGL", "G", "L", "DS")
%   -   init_params:   	{3 × 1} cell array of {x0}{lb}{ub}, where each cell is an [N × 8] matrix of N'th peak parameters: [XLOC,YINT,FWHM,MR,ASY,LSX,LSY,LSW]
%   -   [bgrnd_type]:  	string of the type of background to use for fitting. Default: "none" ("Poly", "Shir", "LinShir")
%   -   [init_bgrnd]:   {3 × 1} cell array of {x0}{lb}{ub}, where each cell is an [1 × 5] matrix of the background parameters: [LHS,RHS,ORD,LAM,DEL,BGR]
