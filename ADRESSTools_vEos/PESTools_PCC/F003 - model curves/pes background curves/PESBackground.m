function [roi_xdat, roi_ydat, roi_bgrnd] = PESBackground(xdat, ydat, bTYPE, LHS, RHS, BGR, ARGS, plot_result)
...
if strcmpi(bTYPE,"Poly")
    if length(ARGS) == 1;   [roi_xdat, roi_ydat, roi_bgrnd]     = BgrndPoly(xdat, ydat, ARGS{1}, LHS, RHS, [], [], plot_result);
    else;                   [roi_xdat, roi_ydat, roi_bgrnd]     = BgrndPoly(xdat, ydat, [], LHS, RHS, [], [], plot_result);
    end
...
elseif strcmpi(bTYPE,"LinShir")
    if length(ARGS) == 1;       [roi_xdat, roi_ydat, roi_bgrnd]     = BgrndShirleyOffset(xdat, ydat, ARGS{1}, [], LHS, RHS, [], [], plot_result);
    elseif length(ARGS) == 2;   [roi_xdat, roi_ydat, roi_bgrnd]     = BgrndShirleyOffset(xdat, ydat, ARGS{1}, ARGS{2}, LHS, RHS, [], [], plot_result);
    else;                       [roi_xdat, roi_ydat, roi_bgrnd]     = BgrndShirleyOffset(xdat, ydat, [], [], LHS, RHS, [], [], plot_result);
    end
% - EXTRACTING STEP-FDD-PRODUCT BACKGROUND
elseif strcmpi(bTYPE,"StepFDDGpL")
    if length(ARGS) == 1;       [roi_xdat, roi_ydat, roi_bgrnd]     = BgrndStepFDDGpL(xdat, ydat, ARGS{1}, [], [], LHS, RHS, [], [], plot_result);
    elseif length(ARGS) == 2;   [roi_xdat, roi_ydat, roi_bgrnd]     = BgrndStepFDDGpL(xdat, ydat, ARGS{1}, ARGS{2}, [], LHS, RHS, [], [], plot_result);
    elseif length(ARGS) == 3;   [roi_xdat, roi_ydat, roi_bgrnd]     = BgrndStepFDDGpL(xdat, ydat, ARGS{1}, ARGS{2}, ARGS{3}, LHS, RHS, [], [], plot_result);
    else;                       [roi_xdat, roi_ydat, roi_bgrnd]     = BgrndStepFDDGpL(xdat, ydat, [], [], [], LHS, RHS, [], [], plot_result);
    end
% - EXTRACTING STEP-FDD-SUM BACKGROUND
elseif strcmpi(bTYPE,"StepFDDGsL")
    if length(ARGS) == 1;       [roi_xdat, roi_ydat, roi_bgrnd]     = BgrndStepFDDGsL(xdat, ydat, ARGS{1}, [], [], LHS, RHS, [], [], plot_result);
    elseif length(ARGS) == 2;   [roi_xdat, roi_ydat, roi_bgrnd]     = BgrndStepFDDGsL(xdat, ydat, ARGS{1}, ARGS{2}, [], LHS, RHS, [], [], plot_result);
    elseif length(ARGS) == 3;   [roi_xdat, roi_ydat, roi_bgrnd]     = BgrndStepFDDGsL(xdat, ydat, ARGS{1}, ARGS{2}, ARGS{3}, LHS, RHS, [], [], plot_result);
    else;                       [roi_xdat, roi_ydat, roi_bgrnd]     = BgrndStepFDDGsL(xdat, ydat, [], [], [], LHS, RHS, [], [], plot_result);
    end
