function [fitStr0, statStr] = xps_parsolver_n_runs(xpsStr, cTYPE, iPESCurves, bTYPE, iPESBgrnd, solve_type, n_runs)
% [fitStr0, statStr] = xps_parsolver_n_runs(xpsStr, cTYPE, iPESCurves, bTYPE, iPESBgrnd, solve_type, n_runs)
...
parfor i = statStr.n_runs
    ...
    % --- Executing the fit
    fitStr{i} = xps_solver(xpsStr, cTYPE, new_init_conds, bTYPE, iPESBgrnd, solve_type);
