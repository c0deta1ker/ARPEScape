function fig = view_arpes2model_init(arpesStr, modelStr, iparams, ibgrnd, kx_lims, eb_lims)
% fig = view_arpes2model_init(ARPES, MODEL, iparams, ibgrnd, kx_lims, eb_lims)
