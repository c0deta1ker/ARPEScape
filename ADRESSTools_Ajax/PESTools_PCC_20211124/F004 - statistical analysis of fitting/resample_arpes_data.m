...
%
%   IN:
%   -   arpes_data:    	(1 x N) cell-array that contains a collection of all ARPES data, loaded and processed using ARPESGUI.
...
%   -   rs_arpes_data:  (1 x N) cell-array that contains all the resampled data.
