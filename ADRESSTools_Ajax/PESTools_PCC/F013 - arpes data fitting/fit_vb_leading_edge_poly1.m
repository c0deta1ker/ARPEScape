function fitStr = fit_vb_leading_edge_poly1(XDat, YDat, DDat, vb_fit_args, plot_results)
% fitStr = fit_vb_leading_edge_poly1(XDat, YDat, DDat, vb_fit_args, plot_results)
%   Function that fits to the valence band leading edge using a 1st order
%   polynomial for both the background and leading edge.
%
%   REQ. FUNCTIONS: none
%
%   IN:
