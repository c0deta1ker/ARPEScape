function fitStr = fit_vb_leading_edge_flat(XDat, YDat, DDat, vb_fit_args, plot_results)
% fitStr = fit_vb_leading_edge_flat(XDat, YDat, DDat, vb_fit_args, plot_results)
%   Function that fits to the valence band leading edge using a 1st order
%   polynomial for the leading edge, but a flat straight line for the
%   background.
%
%   REQ. FUNCTIONS: none
%
