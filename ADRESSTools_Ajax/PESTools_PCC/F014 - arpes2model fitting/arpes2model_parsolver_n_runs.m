function [fitStr0, statStr] = arpes2model_parsolver_n_runs(arpesStr, modelStr, iparams, ibgrnd, solve_type, kx_lims, eb_lims, n_runs)
% [fitStr0, statStr] = arpes2model_parsolver_n_runs(arpesStr, modelStr, iparams, ibgrnd, solve_type, kx_lims, eb_lims, n_runs)
...
%   converged fit parameters. Uses Parallel Processing.
%
%   REQ. FUNCTIONS: none
%
%   IN:
