function fitStr = arpes2model_parsolver(arpesStr, modelStr, iparams, ibgrnd, solve_type, kx_lims, eb_lims)
% fitStr = arpes2model_parsolver(arpesStr, modelStr, iparams, ibgrnd, solve_type, kx_lims, eb_lims)
...
%   minimising the value of chi-squared. Uses Parallel Processing.
%
%   REQ. FUNCTIONS: none
%
%   IN:
...
function [ARPES, MODEL] = extract_arpes_and_model(x, arpesStr, modelStr, kx_lims, eb_lims)
    ...
    imodelStr	= JGkp_interp(modelStr, BOFF, MFP);
