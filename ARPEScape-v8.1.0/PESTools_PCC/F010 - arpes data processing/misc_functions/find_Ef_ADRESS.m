function [fit1,Ef] = find_Ef_ADRESS(Angle,Energy,Data,Angle_window,E_window, plot_result)
% (OLD FUNCTION, NOT USED CURRENTLY)
% [fit1,Ef] = find_Ef_ADRESS(Angle,Energy,Data,Angle_window, E_window, plot_result)
