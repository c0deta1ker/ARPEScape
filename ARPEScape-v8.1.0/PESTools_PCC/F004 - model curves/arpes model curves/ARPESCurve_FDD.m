function zdat = ARPESCurve_FDD(xdat, ydat, cTYPE, INT, XLOC, YLOC, XFWHM, YFWHM, MSTAR, FDEF, FDT, plot_result)
...
if plot_result == 1
    ...
    img_props(); cbar_props(); title('ARPESCurve_FDD()', 'Interpreter', 'none');
