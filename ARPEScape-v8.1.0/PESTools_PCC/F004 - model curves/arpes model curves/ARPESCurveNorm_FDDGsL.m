function zdat = ARPESCurveNorm_FDDGsL(xdat, ydat, cTYPE, INT, XLOC, YLOC, XFWHM, YFWHM, MSTAR, FDEF, FDT, FDW, BGR, BIN, BCO, plot_result)
% zdat = ARPESCurveNorm_FDDGsL(xdat, ydat, cTYPE, INT, XLOC, YLOC, XFWHM, YFWHM, MSTAR, FDEF, FDT, FDW, BGR, BIN, BCO, plot_result)
...
if plot_result == 1
    ...
    img_props(); cbar_props(); title('ARPESCurveNorm_FDDGsL()', 'Interpreter', 'none');
