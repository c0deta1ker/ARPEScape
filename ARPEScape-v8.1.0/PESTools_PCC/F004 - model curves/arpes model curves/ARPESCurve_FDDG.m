function zdat = ARPESCurve_FDDG(xdat, ydat, cTYPE, INT, XLOC, YLOC, XFWHM, YFWHM, MSTAR, FDEF, FDT, FDW, plot_result)
...
if plot_result == 1
    ...
    img_props(); cbar_props(); title('ARPESCurve_FDDG()', 'Interpreter', 'none');
