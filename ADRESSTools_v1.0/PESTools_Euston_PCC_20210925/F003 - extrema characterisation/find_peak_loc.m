...
%   -   type:  		string of the type of method to use ("none","spline","gauss","smooth").
...
iyDat  	= interp1(xDat,yDat,ixDat, 'cubic');
% Resetting data
...
if type == "xps_solver"
    ...
    BE      = mean(xWin, 1)';           % scalar of the binding energy of PE curve. Each new row gives a new BE component. Make sure sizes are all consistent.
