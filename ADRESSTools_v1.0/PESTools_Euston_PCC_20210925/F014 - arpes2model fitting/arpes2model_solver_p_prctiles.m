function [fitStr0, statStr] = arpes2model_solver_p_prctiles(MODEL, ARPES, iparams, ibgrnd, solve_type, n_runs, prc, p_runs)
...
for p = 1:p_runs
    ...
    [fitStr0, statStr{p}] = arpes2model_solver_n_runs(MODEL, ARPES, iparams, ibgrnd, solve_type, n_runs);
