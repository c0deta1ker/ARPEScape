function zdat_fil = data_filter2D(zdat, filType, filXVal, filYVal, plot_result)
% zdat_fil = data_filter2D(zdat, filType, filXVal, filYVal, plot_result)
...
if nargin < 3; filXVal = 1; end
if nargin < 4; filYVal = 1; end
if nargin < 5; plot_result = 1; end
