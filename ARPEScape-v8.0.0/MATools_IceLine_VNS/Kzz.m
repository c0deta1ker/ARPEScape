...
% TltM (scalar/row vector) - manipulator tilt relative to the surface normal + deflection angle 
...
nH=length(HV); nT=length(TltM);
if length(find([nH nT]>1))>1; disp('Error in Kyy: Only one of hv/tilt/defection can be vectorized'); return; end
